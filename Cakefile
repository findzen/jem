...
tempSrcCoffeeDir   = 'tmp'
testSrcCoffeeDir   = 'test/src'

prodTargetJsDir    = 'lib'
testTargetJsDir    = 'test/lib'

prodTargetFileName   = 'jem'
prodTargetCoffeeFile = "#{tempSrcCoffeeDir}/#{prodTargetFileName}.coffee"
...
task 'build', 'Build a single JavaScript file from prod files', ->
  ...
  process = ->
    unless fs.existsSync tempSrcCoffeeDir
      fs.mkdir tempSrcCoffeeDir
